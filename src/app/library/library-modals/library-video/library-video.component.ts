...
@Component({
  selector: 'app-library-video',
  templateUrl: './library-video.component.html',
  styleUrls: ['./library-video.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class LibraryVideoComponent implements OnInit {
